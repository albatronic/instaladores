...
(function($) {
	...
	var struct =(
		...
		'<a href="#prev" class="piro_prev" title="anterior"></a>'+
		'<a href="#next" class="piro_next" title="siguiente"></a>'+
		'<div class="piro_prev_fake">anterior</div>'+
		'<div class="piro_next_fake">siguiente</div>'+
		'<div class="piro_close" title="cerrar"></div>'+
		'</div>'+
